  ...
  rules: {
    ...
    "@typescript-eslint/naming-convention": [
      "error",
      {
        ...
        // Ignore quoted property keys (e.g., { 'foo-bar': true }) often used with clsx
        format: null,
      },
      {
        selector: "default",
    ...
    "simple-import-sort/imports": [
      "error",
      {
        groups: [
          ...
          ["^export .*"],
          // React comes first then external packages
          ["^react$", String.raw`^@?\w`],
          // Internal packages
          [String.raw`^(router|contexts|components|pages|utils|hooks|/)(\/)?`],
          // Store imports
          ["^store/"],
          // Assets imports
          ["^assets/"],

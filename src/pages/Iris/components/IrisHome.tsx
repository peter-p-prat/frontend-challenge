...
const IrisHome: React.FC = () => {
    ...
    return (
        <>
            <TopNavigation title="Iris" onMenuClick={() => {}} />
            <main className="layout-container h-full flex flex-col mb-22">
                <section className="flex-1 flex flex-col items-center justify-center gap-6 px-[26px] relative">
                    ...
                    <h2 className="sr-only">Welcome to Iris</h2>
                    <p className="lg:max-w-md text-center leading-relaxed text-zinc-400">
                        Chat with Iris. The more you engage, the more you'll build self-awareness—and move through life with clarity and
                        confidence.
                    </p>
                </section>
